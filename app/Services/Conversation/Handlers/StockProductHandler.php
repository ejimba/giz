...
class StockProductHandler extends BaseStepHandler implements StepHandlerInterface
{
    ...
    {
        return Step::STOCK_PRODUCT_SELECTION;
    }
    ...
    public function handle(Conversation $conv, string $message): void
    {
        ...
        if (empty($message)) {
            ...
            $list = "Select a product to check stock:\n";
        ...
        $meta['step'] = Step::STOCK_GREEN_PRODUCT;
